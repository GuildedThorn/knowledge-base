...
- [Engineering Research Library](kb://06-reference-engineering-research-library) - broad source-cited engineering corpus: C#/.NET, algorithms, systems, databases, Linux/Nix, networking, architecture, SRE, graphics/VR, and AI/ML.
- [3D Mapping Platforms - Index](kb://06-reference-3d-mapping-platforms-3d-mapping-platforms-index) - ArcGIS Pro, Google Photorealistic 3D Tiles, Mapbox GL JS, and CesiumJS platform notes.
- [USGS EarthExplorer and The National Map Data](kb://06-reference-geospatial-usgs-earthexplorer-and-national-map-data) - official U.S. imagery, elevation, lidar, topo, hydrography, and National Map service/download workflows.
- [Homelab Infrastructure Research](kb://06-reference-homelab-infrastructure-research) - homelab infrastructure research topics: backups, routing, monitoring, identity, secrets, segmentation, and recovery.
...
- [Advanced Networking Concepts](kb://06-reference-advanced-networking-concepts)

## AI / LLM Systems

- [GPTKB: LLM Knowledge Base Construction](kb://06-reference-engineering-ai-ml-systems-gptkb-llm-knowledge-base-construction)
- [LLM Inference Optimization and Compute-Saving Techniques](kb://06-reference-llm-inference-optimization-and-compute-saving-techniques)
- [Local Embedding Models for Semantic Search](kb://06-reference-local-embedding-models-for-semantic-search)
- [Model Context Protocol (MCP) Architecture](kb://06-reference-model-context-protocol-mcp-architecture)
- [Local Voice Pipeline - Whisper STT and Piper TTS](kb://06-reference-local-voice-pipeline-whisper-stt-and-piper-tts)
...
- [Audio Spatialization and DSP](kb://06-reference-audio-spatialization-and-dsp)
- [Game CPU Performance and Profiling](kb://06-reference-game-cpu-performance-and-profiling)
- [Game AI Compute Optimization and Bot Performance](kb://06-reference-game-ai-compute-optimization-and-bot-performance)
...
- [Setup Note Template](kb://90-templates-setup-note-template)
- [Improvement Note Template](kb://90-templates-improvement-note-template)

## Related

- [Software Map](kb://01-maps-software-map)
- [Projects Map](kb://01-maps-projects-map)
- [Improvements Map](kb://01-maps-improvements-map)
